...
const KEYS = {
  AFFIRMATIONS: 'ealo-affirmations',
  TRASH: 'ealo-trash',
  CALENDAR: 'ealo-calendar',
  STREAK: 'ealo-streak',
  THEME: 'ealo-theme',
  ONBOARDING_DONE: 'ealo-onboarded',
  TOMORROW_NOTE: 'ealo-tomorrow-note',
  TODAY_AFFIRMATIONS: 'ealo-today-affirmations',
  WEEKLY_REPORT_SHOWN: 'ealo-weekly-report-shown',
  TOMORROW_ENABLED: 'ealo-tomorrow-enabled',
  CATEGORIES: 'ealo-categories',
  TODAY_EXTRA: 'ealo-today-extra',
  ALARM: 'ealo-alarm',
  ALARM_LIST: 'ealo-alarm-list',
  ALARM_LAST_SHOWN: 'ealo-alarm-last-shown',
  DAY_NOTES: 'ealo-day-notes',
  WEEKLY_SHIELDS: 'ealo-weekly-shields',
  TODAY_REPEAT_DONE: 'ealo-today-repeat-done',
  NAEGE_SEEN_DATE: 'ealo-naege-seen-date',
