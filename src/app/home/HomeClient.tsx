...
import type { RemoteFeatureFlags } from '@/lib/featureFlagsRemote'
...
export function HomeClient({ initialRemoteFlags }: { initialRemoteFlags: RemoteFeatureFlags }) {
  ...
  const [remoteFlags, setRemoteFlags] = useState(initialRemoteFlags)
