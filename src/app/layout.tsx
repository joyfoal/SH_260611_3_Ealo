...
(function(){
  var themes={
    ...
    dark:{bg:{primary:'#1a1a2e',card:'#26215C',dark:'#0D0D1F',surface:'#13132B'},text:{primary:'#EEEDFE',secondary:'#AFA9EC',muted:'#5F5E5A',onDark:'#EEEDFE'},accent:{primary:'#534AB7',secondary:'#7F77DD',light:'#CECBF6',highlight:'#534AB7'},border:'#3C3489',tab:{active:'#AFA9EC',inactive:'#5F5E5A'}},
    ...
    blue:{bg:{primary:'#F4F8FC',card:'#E7EFF7',dark:'#0A1524',surface:'#14243A'},text:{primary:'#0F2337',secondary:'#234875',muted:'#888780',onDark:'#E7EFF7'},accent:{primary:'#1E3A5F',secondary:'#4A72A8',light:'#C7D9EC',highlight:'#234875'},border:'#C7D9EC',tab:{active:'#234875',inactive:'#888780'}}
  };
